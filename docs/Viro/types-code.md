---
title: Type de codes maveillants
sidebar_position: 2
---
...
Maintenir un accès persistant pour des attaques ultérieures (backdoor)
...
Modèle conceptuel utilisé pour décrire les différentes étapes d'une attaque
