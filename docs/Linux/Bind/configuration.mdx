...
```conf
    options {
            ...
            listen-on port 53 { @ip_interface; }; #Ne pas oublier 127.0.0.1
            directory "/var/named";

            #Remplacer @ip_reseau par le réseau autorisé à faire des requêtes
            allow-query { @ip_reseau/CIDR; }; # Mettre ' any; ' pour autoriser tout le monde et ne pas oublier 127.0.0.1

            # Activer cette option pour permet au serveur de contacter le serveurs racines
            recursion yes;
